...
CSF::createOptions($prefix, array(
  'menu_title' => esc_html__('Click to mail', 'click-to-mail'),
  'menu_slug'  => 'ctm',
  'menu_icon' => 'dashicons-email',
  'framework_title' => 'Click to mail <small>by ThemeAtelier</small>',
  'show_bar_menu'           => false,
  'footer_text'             => esc_html__('Thank you for using our product', 'click-to-mail'),
  'theme'                   => 'light',
  'nav'   => 'inline',
  'show_bar_menu' => false,
  'show_sub_menu' => false,
...
CSF::createSection($prefix, array(
  'title'  => esc_html__('GENERAL', 'click-to-mail'),
  ...
  'fields' => array(
    ...
    array(
      'id'         => 'opt-layout-type',
      'type'       => 'button_set',
      'title'      => esc_html__('Layout type', 'click-to-mail'),
      'default' => 'form',
      'options'    => array(
        'form'  => esc_html__('With form', 'click-to-mail'),
        'agent' => esc_html__('With agent message', 'click-to-mail'),
      ),
    ),
    ...
    array(
      'id'    => 'opt-email',
      'type'  => 'text',
      'title' => esc_html__('Email address', 'click-to-mail'),
      'default'  => 'hello@yourdomain.com',
      'subtitle'  => esc_html__('Add your email addresses separate with a comma if you want multiple. eg: hello@yourdomain.com,admin@yourdomain.com', 'click-to-mail'),
    ...
    array(
      'id'    => 'opt-cc-email',
      'type'  => 'text',
      'title' => esc_html__('CC Email address', 'click-to-mail'),
      'default'  => 'ccmaiil@yourdomain.com',
      'subtitle'  => esc_html__('Add your cc email addresses separate with a comma if you want multiple. eg: cc@yourdomain.com,cc2@yourdomain.com', 'click-to-mail'),
    ),
    ...
    array(
      'id'    => 'opt-bcc-email',
      'type'  => 'text',
      'title' => esc_html__('BCC Email address', 'click-to-mail'),
      'default'  => 'bccmail@yourdomain.com',
      'subtitle'  => esc_html__('Add your bcc email addresses separate with a comma if you want multiple. eg: bcc@yourdomain.com,bcc2@yourdomain.com', 'click-to-mail'),
    ...
    array(
      'id'    => 'opt-subject',
      'type'  => 'text',
      'title' => esc_html__('Predefined email subject', 'click-to-mail'),
      'default'  => 'Winter is coming',
      'subtitle'  => esc_html__('Add email subject to fill automatically when user will click to send. Keep blank if you do not want to set anything', 'click-to-mail'),
    ...
    array(
      'id'    => 'opt-bodytext',
      'type'  => 'textarea',
      'title' => esc_html__('Predefined email body', 'click-to-mail'),
      'default'  => 'Fear cuts deeper than words.',
      'subtitle'  => esc_html__('Add email body to fill automatically when user will click to send. Keep blank if you do not want to set anything', 'click-to-mail'),
      'dependency' => array('opt-layout-type', 'any', 'agent'),
    ),
    ...
    array(
      'id'    => 'select-timezone',
      'type'  => 'select',
      'title' => esc_html__('Timezone', 'click-to-mail'),
      'subtitle' => esc_html__('When using the date and time from the user browser you can transform it to your current timezone (in case your user is in a different timezone)', 'click-to-mail'),
      'chosen'      => true,
      'placeholder' => esc_html__('Select timezone', 'click-to-mail'),
      'options' => $timezones,
    ),
    ...
    array(
      'id'    => 'opt-availablity',
      'type'  => 'tabbed',
      'title' => esc_html__('Availablity', 'click-to-mail'),
      'subtitle' => esc_html__('24-hour Time without PM:AM" eg: From 00:00 to 23:59. If you are offline for any specefic full day use 00:00 and 00:00 in From and To value.', 'click-to-mail'),
      // sunday
      'tabs'  => array(
        array(
          'title'  => esc_html__('Sunday', 'click-to-mail'),
          'fields' => array(
            array(
        ...
        // monday
        array(
          'title'  => esc_html__('Monday', 'click-to-mail'),
          'fields' => array(
            array(
        ...
        // tuesday
        array(
          'title'  => esc_html__('Tuesday', 'click-to-mail'),
          'fields' => array(
            array(
        ...
        // wednesday
        array(
          'title'  => esc_html__('Wednesday', 'click-to-mail'),
          'fields' => array(
            array(
        ...
        // thursday
        array(
          'title'  => esc_html__('Thursday', 'click-to-mail'),
          'fields' => array(
            array(
        ...
        // friday
        array(
          'title'  => esc_html__('Friday', 'click-to-mail'),
          'fields' => array(
            array(
        ...
        // thursday
        array(
          'title'  => esc_html__('Saturday', 'click-to-mail'),
          'fields' => array(
            array(
    ...
    array(
      'id'    => 'agent-photo',
      'type'    => 'media',
      'title'   => esc_html__('Agent photo', 'click-to-mail'),
      'subtitle' => esc_html__('Add agent photo to show in the bubble.', 'click-to-mail'),
      'library' => 'image',
      'placeholder' => CTM_DIR_URL . 'assets/image/user.webp',
      'preview' => true,
      'default' => [
    ...
    array(
      'id'    => 'agent-name',
      'type'    => 'text',
      'title'   => esc_html__('Agent name', 'click-to-mail'),
      'subtitle' => esc_html__('Add your/agent name for shoing in bubble.', 'click-to-mail'),
      'default' => esc_html__('John Doe', 'click-to-mail'),
    ),
    ...
    array(
      'id'    => 'agent-subtitle',
      'type'    => 'text',
      'title'   => esc_html__('Subtitle', 'click-to-mail'),
      'subtitle' => esc_html__('Add subtitle to show under agent name', 'click-to-mail'),
      'default' => esc_html__('Typically replies within a day', 'click-to-mail'),
    ),
    ...
    array(
      'id'    => 'agent-message',
      'type'    => 'textarea',
      'title'   => esc_html__('Message from agent', 'click-to-mail'),
      'subtitle' => esc_html__('Add add custom message for shoing in message box.', 'click-to-mail'),
      'default' => esc_html__('Hello, Welcome to the site. Please click the below button for sending me an email.', 'click-to-mail'),
      'dependency' => array('opt-layout-type', 'any', 'agent'),
    ),
    ...
    array(
      'id'    => 'before-chat-icon',
      'type'  => 'icon',
      'title' => esc_html__('Icon for send an email button', 'click-to-mail'),
      'default' => 'far fa-envelope',
      'subtitle' => esc_html__('Change icon for adding before chat button text.', 'click-to-mail'),
    ),
    ...
    array(
      'id'    => 'chat-button-text',
      'type'    => 'text',
      'title'   => esc_html__('Chat button text', 'click-to-mail'),
      'subtitle' => esc_html__('Add chat button text', 'click-to-mail'),
      'default' => esc_html__('Send an email', 'click-to-mail'),
    ),
    ...
    array(
      'id'    => 'autoshow-popup',
      'type'    => 'switcher',
      'title'   => esc_html__('Auto open popup', 'click-to-mail'),
      'subtitle' => esc_html__('Turn ON for open popup automatically.', 'click-to-mail'),
      'default' => false,
    ),
    // bubble position
    array(
      'id'      => 'bubble-position',
      'type'    => 'button_set',
      'title'   => esc_html__('Bubble position', 'click-to-mail'),
      'default' => 'right',
      'options'    => array(
        'right'  => esc_html__('Right', 'click-to-mail'),
        'left' => esc_html__('Left', 'click-to-mail'),
      ),
    ),
    ...
    array(
      ...
      'type'    => 'button_set',
      'title'   => esc_html__('Bubble visibility', 'click-to-mail'),
      'default' => 'everywhere',
      'options'    => array(
        'everywhere'  => esc_html__('Everywhere', 'click-to-mail'),
        'desktop' => esc_html__('Desktop Only', 'click-to-mail'),
        'tablet' => esc_html__('Tablet Only', 'click-to-mail'),
        'mobile' => esc_html__('Mobile Only', 'click-to-mail'),
      ),
    ),
    // bubble style
    array(
      'id'      => 'bubble-style',
      'type'    => 'button_set',
      'title'   => esc_html__('Select bubble layout mode', 'click-to-mail'),
      'default' => 'default',
      'options'    => array(
        'default'  => esc_html__('Light mode', 'click-to-mail'),
        'dark' => esc_html__('Dark mode', 'click-to-mail'),
        'night' => esc_html__('Night mode', 'click-to-mail'),
      ),
    ),
    ...
    array(
      ...
      'type'    => 'button_set',
      'title'   => esc_html__('Bubble header contnet position', 'click-to-mail'),
      'default' => 'center',
      'options'    => array(
        'left'  => esc_html__('Left', 'click-to-mail'),
        'center' => esc_html__('Center', 'click-to-mail'),
      ),
    ),
    ...
    array(
      'id'    => 'select-animation',
      'type'  => 'select',
      'title' => esc_html__('Select animation for bubble', 'click-to-mail'),
      'options' => array(
        '1'     => esc_html__('Fade Right', 'click-to-mail'),
        '2'     => esc_html__('Fade Down', 'click-to-mail'),
        '4'     => esc_html__('Fade In Scale', 'click-to-mail'),
        '5'     => esc_html__('Rotation', 'click-to-mail'),
        '6'     => esc_html__('Slide Fall', 'click-to-mail'),
        '7'     => esc_html__('Slide Down', 'click-to-mail'),
        '3'     => esc_html__('Ease Down', 'click-to-mail'),
        '8'     => esc_html__('Rotate Left', 'click-to-mail'),
        '9'     => esc_html__('Flip Horizontal', 'click-to-mail'),
        '10'    => esc_html__('Flip Vertical', 'click-to-mail'),
        '11'    => esc_html__('Flip Up', 'click-to-mail'),
        '12'    => esc_html__('Super Scaled', 'click-to-mail'),
        '13'    => esc_html__('Slide Up', 'click-to-mail'),
        'random' => esc_html__('Random', 'click-to-mail'),
      ),
      'default'     => 'random',
    ),
    ...
    array(
      'id'      => 'opt-button-style',
      'type'    => 'image_select',
      'title'   => esc_html__('Bubble button style', 'click-to-mail'),
      'options' => array(
        '1' => CTM_DIR_URL . 'assets/image/bubble-1.png',
        '2' => CTM_DIR_URL . 'assets/image/bubble-2.png',
        '3' => CTM_DIR_URL . 'assets/image/bubble-3.png',
        '4' => CTM_DIR_URL . 'assets/image/bubble-4.png',
        '5' => CTM_DIR_URL . 'assets/image/bubble-5.png',
        '6' => CTM_DIR_URL . 'assets/image/bubble-6.png',
        '7' => CTM_DIR_URL . 'assets/image/bubble-7.png',
        '8' => CTM_DIR_URL . 'assets/image/bubble-8.png',
        '9' => CTM_DIR_URL . 'assets/image/bubble-9.png',
      ),
      'default' => '1',
    ),
    ...
    array(
      ...
      'type'  => 'icon',
      'title' => esc_html__('Icon for circle button', 'click-to-mail'),
      'default' => 'far fa-envelope',
      'subtitle' => esc_html__('Change icon for circle button.', 'click-to-mail'),
    ),
    ...
    array(
      ...
      'type'  => 'icon',
      'title' => esc_html__('Icon for circle button close ', 'click-to-mail'),
      'default' => 'far fa-window-close',
      'subtitle' => esc_html__('Change icon for circle button close.', 'click-to-mail'),
    ),
    ...
    array(
      'id'    => 'circle-animation',
      'type'  => 'select',
      'title' => esc_html__('Select animation for circle icon', 'click-to-mail'),
      'options' => array(
        '1'     => esc_html__('Slide down', 'click-to-mail'),
        '2'     => esc_html__('Rotate', 'click-to-mail'),
        '3'     => esc_html__('Fade', 'click-to-mail'),
        '4'     => esc_html__('Slide Up', 'click-to-mail'),
      ),
      'default'     => '1',
    ),
    ...
    array(
      'id'    => 'bubble-text',
      'type'    => 'text',
      'title'   => esc_html__('Bubble text', 'click-to-mail'),
      'subtitle' => esc_html__('Change text to show in bubble', 'click-to-mail'),
      'default' => esc_html__('How may I help you?', 'click-to-mail'),
...
//
CSF::createSection($prefix, array(
  'title'       => esc_html__('SHORTCODES', 'click-to-mail'),
  'icon'        => 'fas fa-code',
  'fields'      => array(
    array(
      'id'      => 'opt-shortcode-select',
      'type'    => 'image_select',
      'title'   => esc_html__('Select button style', 'click-to-mail'),
      'options' => array(
        '1' => CTM_DIR_URL . 'assets/image/button-with-info.png',
        '2' => CTM_DIR_URL . 'assets/image/button2.png',
      ),
      'default' => '1',
    ),
    ...
    array(
      'type'    => 'content',
      'content' => '[ctm style="1" number="+8815647788844" timezone="Asia/Dhaka" photo="/wp-content/uploads/2022/11/user.webp" name="Jhon" designation="Techinical support" label="How can I help you?" online="I am on" offline="I am off" visibility="ctm-show-everywhere" sizes="ctm-btn-lg" sunday="00:00-23:59" monday="23:00-23:59" tuesday="00:00-23:59" wednesday="00:00-23:59" thursday="00:00-23:59" friday="00:00-23:59" saturday="00:00-23:59"]',
      'title' => esc_html__('Copy this shortcode and paste it in any pages/posts/widget. Edit values as you need.', 'click-to-mail'),
      'dependency' => array('opt-shortcode-select', 'any', '1'),
    ),

    array(
      'type'    => 'content',
      'content' => '[ctm style="2" number="+8815647788844" label="How can I help you?" visibility="ctm-show-everywhere" sizes="ctm-btn-lg"]',
      'title' => esc_html__('Copy this shortcode and paste it in any pages/posts/widget. Edit values as you need.', 'click-to-mail'),
...
//
CSF::createSection($prefix, array(
  'title'       => esc_html__('BACKUP', 'click-to-mail'),
  'icon'        => 'fas fa-shield-alt',
  'description' => esc_html__('Export or import to use same settings in different websites.', 'click-to-mail'),
  'fields'      => array(
    array(
      'type' => 'backup',
    ),
